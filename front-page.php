<?php get_header(); ?>
<?php
	$theme_option = flagship_sub_get_global_options(); //Theme option function
		...
		<?php while ($slider_query->have_posts()) : $slider_query->the_post(); ?>
			<a href="<?php echo get_post_meta($post->ID, 'ecpt_urldestination', true); ?>">
				<div class="slide">
					...
					<?php /******Get caption style based on theme options*****/
						if($theme_option['flagship_sub_slider_style'] == "vertical") { locate_template('parts-vertical-slider.php', true, false); }
					 	elseif($theme_option['flagship_sub_slider_style'] == "horizontal") { locate_template('parts-horizontal-slider.php', true, false); } ?>
				</div>
			</a>
		<?php endwhile; ?>							
	</div> <!-- End #slider -->
...
<?php /*******Homepage sidebar - Yes or No********/
	if ( $theme_option['flagship_sub_sidebar']  == '1' ) { ?>
